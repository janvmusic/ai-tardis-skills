...
3. Trigger the `release.yml` GitHub Actions workflow by running: `gh workflow run release.yml`
4. Confirm the workflow was triggered and show the user the Actions URL to monitor progress: `https://github.com/janvmusic/ai-tardis-skills/actions`
